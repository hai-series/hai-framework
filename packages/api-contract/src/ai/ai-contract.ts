...
export const aiContract = {
  chats: {
    createCompletion: oc
      .route({ method: 'POST', path: '/ai/chats/completions', operationId: 'ai.chats.createCompletion', summary: 'Create chat completion', tags: ['ai', 'chats'] })
      .input(AiChatCompletionInputSchema)
      .output(AiChatCompletionOutputSchema),
    sendMessage: oc
      .route({ method: 'POST', path: '/ai/chats/messages', operationId: 'ai.chats.sendMessage', summary: 'Send a single chat message', tags: ['ai', 'chats'] })
      .input(AiSendMessageInputSchema)
      .output(AiSendMessageOutputSchema),
    listHistory: oc
      .route({ method: 'POST', path: '/ai/chats/history', operationId: 'ai.chats.listHistory', summary: 'List chat history', tags: ['ai', 'chats'] })
      .input(AiChatHistoryInputSchema)
      .output(AiChatHistoryOutputSchema),
  },
  memories: {
    recall: oc
      .route({ method: 'POST', path: '/ai/memories/recall', operationId: 'ai.memories.recall', summary: 'Recall relevant memories', tags: ['ai', 'memories'] })
      .input(AiMemoryRecallInputSchema)
      .output(AiMemoryRecallOutputSchema),
    list: oc
      .route({ method: 'POST', path: '/ai/memories/list', operationId: 'ai.memories.list', summary: 'List memories', tags: ['ai', 'memories'] })
      .input(AiMemoryListInputSchema)
      .output(AiMemoryListOutputSchema),
  },
  sessions: {
    list: oc
      .route({ method: 'POST', path: '/ai/sessions/list', operationId: 'ai.sessions.list', summary: 'List sessions', tags: ['ai', 'sessions'] })
