---
name: hai-build
description: hai-framework 应用开发入口技能。提供项目架构总览、模块初始化顺序、技能导航与开发工作流。当用户需要了解项目结构、查找正确的技能、或开始新任务时触发。
---

# hai-build — 应用开发入口

> 本技能是 hai-framework 应用开发的起点。帮助理解项目结构、定位正确的技能、并遵循标准工作流。
...
| 编写/补充测试          | `hai-app-tests`  | 测试, test, 单测, 覆盖率               |
