...
export default defineConfig({
  ...
  external: ['@h-ai/core', '@h-ai/vecdb', '@h-ai/reldb', '@h-ai/datapipe', 'openai', 'mem0ai', 'better-sqlite3', 'nanoid', '@modelcontextprotocol/sdk', '@a2a-js/sdk', '@lancedb/lancedb', '@qdrant/js-client-rest', 'zod'],
})
