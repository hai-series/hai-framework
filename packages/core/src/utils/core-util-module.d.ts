 ...
 * ```
 */
export declare function createNotInitializedKit<E extends BaseModuleError>(code: E['code'], messageFn: () => string): NotInitializedKit<E>
// # sourceMappingURL=core-util-module.d.ts.map
