...
declare global {
  ...
  const MessageContainer: typeof import('@h-ai/ui')['MessageContainer']
  const MessageBoxContainer: typeof import('@h-ai/ui')['MessageBoxContainer']
  const MessageBoxDialog: typeof import('@h-ai/ui')['MessageBoxDialog']
